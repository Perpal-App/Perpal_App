...
/**
 * Artwork palette, not design tokens.
 *
 * These are illustration colours belonging to one drawing — they are not a semantic role the
 * app can reuse, and putting them in the theme would invite exactly that. The source SVG
 * carried them as CSS classes, which `react-native-svg` has no `<style>` support for, so each
 * one is named here and applied per shape.
 */
const SKIN = '#F2A196';
const SKIN_SHADE = '#E88870';
const SHIRT = '#FF2609';
const HAIR = '#845161';
const HAIR_SHADE = '#69303A';
const INK = '#00214E';

export function Avatar1({ size }: AvatarProps) {
  return (
    <Svg height={size} viewBox="0 0 366.34 366.34" width={size}>
      ...
      />
      <Path
        d="M214.82,258c-3.7.43-10-1-13.48-2.89-13-7.18-19.49-13-26.38-18.08-8.2-6.06-29.8-25.5-29.8-25.5-.07-2.26-.21-3.76-.24-6q-.06-4.75-.1-9.51l2,1,5.2,2.69,2.41.41,27.88,4.74,31.12,5.3.94,32,.31,10.46.15,5.08V258Z"
        fill={SKIN_SHADE}
      />
      <Path
      ...
      <Path
        ...
        fill={HAIR_SHADE}
      />
      <Circle cx="134.98" cy="168" fill={SKIN} r="17" />
      <Circle cx="140.37" cy="168" fill={SKIN_SHADE} r="15.22" />
      <Path
        d="M140.6,152l4.38,55,66.44,40.88A19.77,19.77,0,0,0,236.1,238a267.38,267.38,0,0,0,13.14-31.88c2.64-7.84,5.22-15.89,5.47-24.23s-2.12-17-5-24.7c-.3-.81-1.9-3.3-1.76-4.15q1.67-10,3.32-19.94c1.26-7.51,2.87-15.35,1-22.9-2.13-8.66-8.67-12.35-14.05-18.82-14.16,18.24-37.44,28.55-57.77,39C170,135.78,140.6,152,140.6,152Z"
        fill={SKIN}
      />
      <Path
        d="M251.07,200.5c-4.31,16.92-9.08,34.35-12.63,40.61-2.66,4.67-6.37,5.57-12.24,7a51.47,51.47,0,0,1-42.29-8.94l-39.09-31.48c-.6-5.89-1-6.79-1.29-12.71-.14-2.68-1-5.36-.36-8a6.9,6.9,0,0,0,1.7,3.73c4.73,6.42,10.25,13.67,18.11,16.31,8.2,2.75,17.53,3.18,25.45-.7,6.89-3.38,13.64-7.79,20.83-10.57a35.05,35.05,0,0,1,15.11-2.61c7.34.5,10.48,3.81,15.85,8.18,1.76,1.44,3.73,2.94,6,3C248.78,204.27,248.91,202.15,251.07,200.5Z"
        fill={HAIR}
      />
      <Path d="M189.72,149.8c6.1,0,6.1,9.38,0,9.43h-.28c-6.1,0-6.1-9.38,0-9.43h.28Z" fill={INK} />
      <Path d="M239.84,148.41c5.67.05,5.67,8.7,0,8.75h-.25c-5.66,0-5.66-8.7,0-8.75h.25Z" fill={INK} />
      <Path
      ...
      />
      <Path
        d="M209.52,203a28.12,28.12,0,0,0,17.4.32c.61-.19.35-1.16-.26-1a27.17,27.17,0,0,1-16.87-.31c-.61-.21-.87.75-.27,1Z"
        fill={SKIN}
      />
    </Svg>
  );
